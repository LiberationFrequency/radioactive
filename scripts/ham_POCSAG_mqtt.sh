...
MQTT_HOST="localhost"
MQTT_TOPIC1="/radio/ham/pocsag/raw"
###MQTT_TOPIC2="/radio/ham/pocsag/json"
PAGER_FREQ="439.9875M"

rtl_fm -d RTL003 -p 18 -g 7.1 -f "$PAGER_FREQ" -M nfm -s 22050 - \
| multimon-ng -t raw -c -a POCSAG1200 --timestamp /dev/stdin \
| while read LINE
do
  ...
  #mosquitto_pub -h $MQTT_HOST -q 0 -t $MQTT_TOPIC2 -m "$json" -i "bombeck" -u "bombeck" -P "NdPhmS"
done &
